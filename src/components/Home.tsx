...
function Home() {
  ...
  return (
    <>
      <section id="home" className="w-screen h-90 md:h-150 home">
        <div className="h-full md:h-full w-full bg-main flex flex-col justify-center items-center">
          ...
          <div className="h-1/5 md:h-1/15 w-full flex flex-col justify-start items-center">
            <h1 className="h-4/5 w-5/6 md:h-2/3 md:w-1/2 text-white font-md text-center"><b>Message from the CEO:</b> Srigan Siva</h1>
          </div>
