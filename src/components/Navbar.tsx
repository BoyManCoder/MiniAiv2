...
function Navbar(){
    return(
        ...
        <nav>
        <section className="w-screen navbarA h-12 md:h-16 bg-dark flex justify-center items-center text-sm md:text-lg">
            <div className="w-full flex flex-row justify-between items-center">
                ...
                <div className="text-white flex flex-row w-full md:w-2/5 md:mr-12 h-1/2 justify-around items-center md:justify-between">
                    ...
                    <a>
                        <button className="h-8 text-center md:h-10 px-4 md:px-6 bg-bright hover:bg-green-600 transition-all hover:text-white text-gray-800 rounded-lg">Contact</button>
                    </a>
                </div>
            </div>
        </section>
